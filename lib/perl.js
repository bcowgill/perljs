/**
	...
	@todo unless(condition, function_) - executes the function if !condition
...
;(function (root, factory) {
	...
	*/
	...
	/**
		...
		@param {function} function_ a function to hash the values so they are unique
		if necessary.
	...
	*/
	perljs.makeMap = function (aArray, defaultValue) {
		...
		// prettier argues with unicorn here...
		function_ =
	...
	*/
	perljs.x = function (token, repeat) {
		...
		// we actually want the different behaviour of isNan vs Number.isNan here...
